    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          >
            <div
              className={`flex items-center justify-center rounded-lg shadow-lg group-hover:shadow-blue-500/50 transition-all duration-300 overflow-hidden ${
            ...
            <div
              className={`font-bold bg-gradient-to-r from-blue-400 via-blue-300 to-blue-400 bg-clip-text text-transparent transition-all duration-300 ${
