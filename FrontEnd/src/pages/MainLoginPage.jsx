...
const App = () => {
    ...
    const pages = {
        login: (
            <LoginPage
                {...{
                    formData, handleInputChange, errors, handleSubmit,
                    isLoading, setCurrentPage, showPassword, setShowPassword,
                }}
            />
        ),
        signup: (
            <SignupPage
                {...{
                    formData, handleInputChange, errors, handleSubmit,
                    isLoading, setCurrentPage, showPassword, setShowPassword,
                    showConfirmPassword, setShowConfirmPassword, termsAccepted,
                    setTermsAccepted, setTermsPopupOpen,
                }}
            />
        ),
